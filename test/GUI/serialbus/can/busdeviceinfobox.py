...
from ui_busdeviceinfobox import Ui_BusDeviceInfoBox
...
class BusDeviceInfoBox(QGroupBox):

    def __init__(self, parent):
        super().__init__(parent)
        self.m_ui = Ui_BusDeviceInfoBox()
    ...
    def set_device_info(self, info):
        ...
        self.m_ui.channelLabel.setText(f"Channel: {info}")
        self.m_ui.isFlexibleDataRateCapable.setChecked(True)
