...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"../../icon/jidu.ico", QSize(), QIcon.Normal, QIcon.On)
        MainWindow.setWindowIcon(icon)
        MainWindow.setWindowOpacity(1.000000000000000)
        self.actionConnect = QAction(MainWindow)
        self.actionConnect.setObjectName(u"actionConnect")
        icon1 = QIcon()
        icon1.addFile(u":/images/connect.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/disconnect.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.actionAboutJiDUSignal = QAction(MainWindow)
        self.actionAboutJiDUSignal.setObjectName(u"actionAboutJiDUSignal")
        self.actionClearLog = QAction(MainWindow)
        self.actionClearLog.setObjectName(u"actionClearLog")
        icon4 = QIcon()
        icon4.addFile(u":/images/clear.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.menuHelp.addAction(self.actionAboutJiDUSignal)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"JiDU Signal", None))
        # if QT_CONFIG(tooltip)
        MainWindow.setToolTip(
            QCoreApplication.translate("MainWindow", u"<html><head/><body><p>CAN/LIN/FlexRay SDK</p></body></html>",
                                       None))
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        MainWindow.setStatusTip(QCoreApplication.translate("MainWindow", u"CAN/LIN/FlexRay SDK", None))
        ...
        self.actionAboutJiDUSignal.setText(QCoreApplication.translate("MainWindow", u"&About", None))
        ...
        # if QT_CONFIG(tooltip)
        self.actionPluginDocumentation.setToolTip(
            QCoreApplication.translate("MainWindow", u"Open plugin documentation in Webbrowser", None))
        # endif // QT_CONFIG(tooltip)
        self.actionResetController.setText(QCoreApplication.translate("MainWindow", u"&Reset Controller", None))
        # if QT_CONFIG(tooltip)
        ...
        self.sendFrameBox.setTitle(QCoreApplication.translate("MainWindow", u"Send frame", None))
        self.receivedMessagesBox.setTitle(QCoreApplication.translate("MainWindow", u"Received messages", None))
