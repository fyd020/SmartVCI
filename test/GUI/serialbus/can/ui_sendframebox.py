...
class Ui_SendFrameBox(object):
    ...
    def retranslateUi(self, SendFrameBox):
        ...
        # if QT_CONFIG(tooltip)
        self.remoteFrame.setToolTip(
            QCoreApplication.translate("SendFrameBox", u"Sends a CAN remote request frame.", None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.extendedFormatBox.setToolTip(
            QCoreApplication.translate("SendFrameBox", u"Allows extended frames with 29 bit identifier.", None))
        # endif // QT_CONFIG(tooltip)
        self.extendedFormatBox.setText(QCoreApplication.translate("SendFrameBox", u"E&xtended Format", None))
        # if QT_CONFIG(tooltip)
        self.flexibleDataRateBox.setToolTip(
            QCoreApplication.translate("SendFrameBox", u"Allows up to 64 byte payload data.", None))
        # endif // QT_CONFIG(tooltip)
        self.flexibleDataRateBox.setText(QCoreApplication.translate("SendFrameBox", u"&Flexible Data-Rate", None))
        # if QT_CONFIG(tooltip)
        self.bitrateSwitchBox.setToolTip(
            QCoreApplication.translate("SendFrameBox", u"Sends payload at higher data rate.", None))
        # endif // QT_CONFIG(tooltip)
