...
class Ui_ConnectDialog(object):
    def setupUi(self, ConnectDialog):
        ...
        self.deviceInfoBox = BusDeviceInfoBox(ConnectDialog)
    ...
    def retranslateUi(self, ConnectDialog):
        ...
        self.selectPluginBox.setTitle(QCoreApplication.translate("ConnectDialog", u"Select Device", None))
        self.groupBox.setTitle(QCoreApplication.translate("ConnectDialog", u"GUI Settings", None))
        # if QT_CONFIG(tooltip)
        self.ringBufferBox.setToolTip(
            QCoreApplication.translate("ConnectDialog",
                                       u"<html><head/><body><p>Use ring buffer in table view model</p></body></html>",
                                       None))
        # endif // QT_CONFIG(tooltip)
        self.ringBufferBox.setText(QCoreApplication.translate("ConnectDialog", u"Use ring buffer", None))
        # if QT_CONFIG(tooltip)
        self.ringBufferLimitBox.setToolTip(
            QCoreApplication.translate("ConnectDialog",
                                       u"<html><head/><body><p>Limit of ring buffer in table view model</p></body></html>",
                                       None))
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.autoscrollBox.setToolTip(QCoreApplication.translate(
            "ConnectDialog",
            u"<html><head/><body><p>Scroll to bottom table view on each portion of received frames</p></body></html>",
            None))
        # endif // QT_CONFIG(tooltip)
        ...
        self.specifyInterfaceNameBox.setTitle(QCoreApplication.translate("ConnectDialog", u"Specify Channel", None))
        self.deviceInfoBox.setTitle(QCoreApplication.translate("ConnectDialog", u"Device Properties", None))
    # retranslateUi
