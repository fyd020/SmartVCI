...
def receive_one_can_signal():
    ...
    # 获取接收到的信号, "DoorOpenerPassReqTrigSrc"是想要接收的信号，timeout是最大接收时长
    result = receiver.receive_signals_once("DoorOpenerPassReqTrigSrc", timeout=10)
