...
"""
@File        : basic.py
@Author      : fyd020@163.com
@Time        : 2025/1/7 22:11
@Update Time :
@Description : smart_vci dll/so definition file
...
PCAN_RECEIVE_STATUS = TPCANParameter(0x0F)  # RawMessage reception status of a PCAN-Channel
...
# ///////////////////////////////////////////////////////////
# SmartVCI-Basic API function declarations
# ///////////////////////////////////////////////////////////


# SmartVCI-Basic API class implementation
#
class SmartVCIBasic:
    """SmartVCI-Basic API class implementation"""

    def __init__(self):
        # Loads the SmartVCI API
        #
        if platform.system() == "Windows":
            ...
            if _arch == '32bit':
                dll_path = libc_path / "smartvci" / "windows" / "x86" / "SmartVCI.dll"
            else:
                dll_path = libc_path / "smartvci" / "windows" / "x64" / "SmartVCI.dll"
            self.__m_dllBasic = windll.LoadLibrary(str(dll_path))
        ...
        #     dll_path = libc_path / "pcan" / "windows" / "x64" / "PCANBasic.dll"
