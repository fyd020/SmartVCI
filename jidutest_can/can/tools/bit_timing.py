...
class BitTiming(Mapping):
    ...
    def __init__(
        ...
        :param int only_listen:
            Either 0 or 1. tosun can only listen flag
        :raises ValueError:
    ...
    def from_registers(
        ...
        only_listen = 1 if btr1 & 0x80 else 0
        return cls(
            brp=brp,
            f_clock=f_clock,
            tseg1=tseg1,
    ...
    @property
    def only_listen(self) -> int:
        """only listen flag (0 or 1)."""
        return self._data["only_listen"]
