...
from jidutest_can.can.io import BaseRotatingLogger
from jidutest_can.can.io.generic import MessageWriter
from jidutest_can.can import CanBus
from jidutest_can.can.interfaces import BusState
from jidutest_can.can.io import Logger
from jidutest_can.can.io import SizedRotatingLogger
from jidutest_can.can.typechecking import CanFilter
from jidutest_can.can.typechecking import CanFilters
...
def _create_base_argument_parser(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        "to opening the bus with `CanBus('vector', channel=1, app_name='MyCanApp')",
    )
...
def _create_bus(parsed_args: Any, **kwargs: Any) -> can.CanBus:
    ...
    return CanBus(parsed_args.channel, **config)  # type: ignore
